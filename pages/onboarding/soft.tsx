...
export default function OnboardingSoft(){
      ...
      <div className="mx-auto max-w-4xl space-y-8">
        <header className="mb-2 text-center">
          ...
          <p className="mx-auto mt-2 max-w-2xl text-neutral-600">
            Share your philosophy and preferences so we tailor our analysis and recommendations.
          </p>
          <div className="mt-3 text-xs text-neutral-500">{saved ? 'Changes saved' : 'Autosaving…'}</div>
        </header>
